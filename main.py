...
PROFILE_REGION_OPTIONS = [
    "전국",
    "서울 전체", "서울 종로구", "서울 중구", "서울 용산구", "서울 성동구", "서울 광진구", "서울 동대문구", "서울 중랑구", "서울 성북구", "서울 강북구", "서울 도봉구", "서울 노원구", "서울 은평구", "서울 서대문구", "서울 마포구", "서울 양천구", "서울 강서구", "서울 구로구", "서울 금천구", "서울 영등포구", "서울 동작구", "서울 관악구", "서울 서초구", "서울 강남구", "서울 송파구", "서울 강동구",
    ...
    "인천 전체", "인천 중구", "인천 동구", "인천 미추홀구", "인천 연수구", "인천 남동구", "인천 부평구", "인천 계양구", "인천 서구", "강화군", "옹진군",
    "부산 전체", "부산 중구", "부산 서구", "부산 동구", "부산 영도구", "부산 부산진구", "부산 동래구", "부산 남구", "부산 북구", "부산 해운대구", "부산 사하구", "부산 금정구", "부산 강서구", "부산 연제구", "부산 수영구", "부산 사상구", "기장군",
    "대구 전체", "대구 중구", "대구 동구", "대구 서구", "대구 남구", "대구 북구", "대구 수성구", "대구 달서구", "달성군", "군위군",
    "광주 전체", "광주 동구", "광주 서구", "광주 남구", "광주 북구", "광주 광산구",
    "대전 전체", "대전 동구", "대전 중구", "대전 서구", "대전 유성구", "대전 대덕구",
    "울산 전체", "울산 중구", "울산 남구", "울산 동구", "울산 북구", "울주군",
    "세종 전체", "세종시",
...
def company_profile_page():
    profile = load_company_profile()
    body = f'''
    <div class="card"><div class="summary"><span class="badge">회사 프로필 등록</span><span class="badge">전국 시·군·구 선택 가능</span><a class="top-btn" href="/">첫 화면</a><a class="top-btn" href="/bids/songwon-page">전체 공고 보기</a></div></div>
    ...
    return page_layout("회사 프로필 등록", "회사 정보, 전국 지역, 면허, 자재납품 품목을 저장하는 화면입니다", body)
